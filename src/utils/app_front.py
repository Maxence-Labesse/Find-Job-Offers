...
def submit_offer_search(root, job_to_search, selected_depth):
    """when "Get job offers" button is pressed, scrape data according to job_searched and period filled by user
    ...
    request_got_blocked = collect_offers(job_to_search, int(days_depth))
